...
if (isset($_GET['nm_pelajaran'])) {
    $query = $DB_con->query("SELECT * FROM jadwal_ujian WHERE pelajaran = '$_GET[nm_pelajaran]'");
...
<html>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				?>
				<h1>
					Jadwal Ujian <?php echo $data_pel['nm_pelajaran'] ?>
				</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Jadwal Ujian <?php echo $data_pel['nm_pelajaran'] ?></li>
				</ol>
				<?php endforeach; ?>
			</section>
	...
	<div class="row">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
						...
						$tt = $t->fetch(PDO::FETCH_ASSOC);
						$date_s = $tt['tanggal'];
						$kueri = "SELECT * FROM jadwal_ujian WHERE pelajaran = '$data[pelajaran]' AND tgl_ujian <= '$date_s' AND sampai >= '$date_s' AND kelas = '$siswa[kelas]' AND nm_kelas = '$siswa[nm_kelas]' ORDER BY kd_ujian DESC";
						foreach ($DB_con->query($kueri) as $data_m) :
						?>
						<tr>
							<td><?php echo $data_m['tgl_ujian'] ?></td>
							<td><?php echo $data_m['sampai'] ?></td>
							<td><?php echo $data_m['nm_ujian'] ?></td>
							<td><?php echo $data_m['pelajaran'] ?></td>
							<td><?php echo $data_m['kelas'] ?></td>
							<td><?php echo $data_m['nm_kelas'] ?></td>
							<td valign="center">
								<a href="mulai_ujian.php?kd_ujian=<?php echo $data_m['kd_ujian'] ?>" title="Mulai Ujian">
									<button type="button" class="btn btn-default btn-sm">
										<i class="fa fa-play"> klik untuk ujian</i>
									</button>
								</a>
							</td>
						</tr>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Jadwal Ujian Selanjutnya</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
						...
						<?php
							...
							$tt = $t->fetch(PDO::FETCH_ASSOC);
							$date_ss = $tt['tanggal'];
						    $sql = "SELECT * FROM jadwal_ujian WHERE pelajaran = '$data[pelajaran]' AND tgl_ujian > '$date_ss' AND kelas = '$siswa[kelas]' AND nm_kelas = '$siswa[nm_kelas]'";
						    foreach ($DB_con->query($sql) as $dataaq) :
						?>
						<tr>
							<td><?php echo $dataaq['tgl_ujian'] ?></td>
							<td><?php echo $dataaq['sampai'] ?></td>
							<td><?php echo $dataaq['nm_ujian'] ?></td>
	  ...
	  <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Ujian Sebelumnya</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
						...
						<?php
							...
							$tt = $t->fetch(PDO::FETCH_ASSOC);
							$date_ss = $tt['tanggal'];
						    $sql = "SELECT * FROM jadwal_ujian WHERE pelajaran = '$data[pelajaran]' AND sampai < '$date_ss' AND kelas = '$siswa[kelas]' AND nm_kelas = '$siswa[nm_kelas]' ORDER BY kd_ujian DESC";
						    foreach ($DB_con->query($sql) as $dataaq) :
						?>
						<tr>
							<td><?php echo $dataaq['tgl_ujian'] ?></td>
							...
							<td><?php echo $dataaq['nm_kelas'] ?></td>
							<td valign="center">
								<a href="lihat_ujian_sebelumnya.php?kd_ujian=<?php echo $dataaq['kd_ujian'] ?>" title="Lihat Soal">
									<button type="button" class="btn btn-default btn-sm">
