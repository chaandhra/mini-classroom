			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							<li class="active"><a href="data_pelajaran.php"><i class="fa fa-folder-open"></i> Data Pelajaran</a></li>
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="myTable">
					...
					<?php
						include 'koneksi.php';
					    $sql = "SELECT * FROM pelajaran ORDER BY nm_pelajaran";
					...
					?>
						<tr>
							...
							<td valign="center">
								<a href="hapus_pelajaran.php?kd_pelajaran=<?php echo $data['kd_pelajaran'] ?>" onclick="return confirm('Anda yakin akan menghapus data?')" title="Hapus">
