...
<?php
if (isset($_GET['id'])) {
    $query = $DB_con->query("SELECT * FROM bidang_study WHERE id = '$_GET[id]'");
	...
	<div class="wrapper">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="edit_data_bidang.php"><i class="fa fa-edit"></i> Edit Data Bidang Study</a></li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Form Edit Data Bidang Study
				</h1>
				<ol class="breadcrumb">
					<li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
					<li>Dashboard</li>
					<li class="active">Form Edit Data Bidang Study</li>
				</ol>
			</section>
			<section class="content">
				<form method="post" class="eusi" enctype="multipart/form-data" action="update_bidang.php" style="margin-left:auto;margin-right:auto;background-color:#fff">
					<div class="container" style="width:100%">
						...
						<label>Nama Bidang Study</label>
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Masukkan Nama Bidang Study" name="nm_bs" value="<?php echo $data['nm_bs'] ?>" required>
