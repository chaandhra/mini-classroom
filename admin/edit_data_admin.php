...
<?php
if (isset($_GET['nia'])) {
    $query = $DB_con->query("SELECT * FROM admin WHERE nia = '$_GET[nia]'");
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="edit_data_admin.php"><i class="fa fa-edit"></i> Edit Data Admin</a></li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#">
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li>Dashboard</li>
					<li class="active">Form Edit Data Admin</li>
				</ol>
			</section>
			<section class="content">
				<form method="post" class="eusi" enctype="multipart/form-data" action="update.php" style="margin-left:auto;margin-right:auto;background-color:#fff">
					<div class="imgcontainer">
						<img src="<?php echo"../upload/admin/".$data['gambar'] ?>" id="preview_gambar" alt="Coba Gambar Lain" class="avatar">
					...
					<div class="container" style="width:100%">
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="hidden" name="nia" value="<?php echo $data['nia'] ?>">
						<label>Nama</label>
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Masukkan Nama" name="nama" value="<?php echo $data['nama'] ?>" required>
