	...
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							<li class="active"><a href="data_siswa.php"><i class="fa fa-folder-open"></i> Data Siswa</a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<input class="alus" style="padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" id="myInputt" onkeyup="ngajarann()" placeholder="Cari dengan nisn">
              ...
              <table class="table table-hover" id="myTable">
					...
					?>
						<tr>
							...
							<td><center><?php echo"<img src=../upload/siswa/".$data['gambar']." width=100 height=100>" ?></center></td>
							...
							<td><?php echo $data['bidang_study'] ?></td>
							...
							<td valign="center">
								<a href="edit_data_siswa.php?nisn=<?php echo $data['nisn'] ?>" title="Edit">
							...
							<td valign="center">
								<a href="hapus_siswa.php?nisn=<?php echo $data['nisn'] ?>" title="Hapus" onclick="return confirm('Anda yakin akan menghapus data?')">
									<button type="button" class="btn btn-default btn-sm">
