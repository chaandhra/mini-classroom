				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							<li class="active"><a href="data_admin.php"><i class="fa fa-folder-open"></i> Data Admin</a></li>
              ...
              <table class="table table-hover" id="myTable">
					...
					?>
						<tr>
							...
							<td><center><?php echo"<img src=../upload/admin/".$data['gambar']." width=100 height=100>" ?></center></td>
							...
							<td valign="center">
								<a href="edit_data_admin.php?nia=<?php echo $data['nia'] ?>" title="Edit">
							...
							<td valign="center">
								<a href="hapus.php?nia=<?php echo $data['nia'] ?>" onclick="return confirm('Anda yakin akan menghapus data?')" title="Hapus">
									<button type="button" class="btn btn-default btn-sm">
