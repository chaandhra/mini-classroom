...
<?php
if (isset($_GET['id'])) {
    $query = $DB_con->query("SELECT * FROM kelas WHERE id = '$_GET[id]'");
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="edit_data_kelas.php"><i class="fa fa-edit"></i> Edit Data Kelas</a></li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#">
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li>Dashboard</li>
					<li class="active">Form Edit Data Kelas</li>
				</ol>
			</section>
			<section class="content">
				<form method="post" class="eusi" enctype="multipart/form-data" action="update_kelas.php" style="margin-left:auto;margin-right:auto;background-color:#fff">
					<div class="container" style="width:100%">
						...
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Masukkan Nama Kelas" name="kelas" value="<?php echo $data['kelas'] ?>" required>
