	...
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							<li class="active"><a href="data_guru.php"><i class="fa fa-folder-open"></i> Data Guru</a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<input class="alus" style="padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" id="myInputt" onkeyup="ngajarann()" placeholder="Cari dengan nip">
              ...
              <table class="table table-hover" id="myTable">
					...
					?>
						<tr>
							...
							<td><center><?php echo"<img src=../upload/guru/".$data['gambar']." width=100 height=100>" ?></center></td>
							...
							<td valign="center">
								<a href="edit_data_guru.php?nip=<?php echo $data['nip'] ?>" title="Edit">
							...
							<td valign="center">
								<a href="hapus_guru.php?nip=<?php echo $data['nip'] ?>" onclick="return confirm('Anda yakin akan menghapus data?')" title="Hapus">
									<button type="button" class="btn btn-default btn-sm">
