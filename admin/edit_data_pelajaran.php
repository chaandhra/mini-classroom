...
if (isset($_GET['kd_pelajaran'])) {
    $query = $DB_con->query("SELECT * FROM pelajaran WHERE kd_pelajaran = '$_GET[kd_pelajaran]'");
    $data  = $query->fetch(PDO::FETCH_ASSOC);
} else {
    echo "Nomor induk tidak tersedia!
<a href='data_pelajaran.php'>Kembali</a>";
    exit();
}
	...
	<div class="wrapper">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="edit_data_pelajaran.php"><i class="fa fa-edit"></i> Edit Data Pelajaran</a></li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#">
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Form Edit Data Pelajaran
				</h1>
				<ol class="breadcrumb">
					<li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
					<li>Dashboard</li>
					<li class="active">Form Edit Data Pelajaran</li>
				</ol>
			</section>
			<section class="content">
				<form method="post" class="eusi" enctype="multipart/form-data" action="update_pelajaran.php" style="margin-left:auto;margin-right:auto;background-color:#fff">
					<div class="container" style="width:100%">
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="hidden" name="kd_pelajaran" value="<?php echo $data['kd_pelajaran'] ?>">
						<label>Nama Pelajaran</label>
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Masukkan Nama Pelajaran" name="nm_pelajaran" value="<?php echo $data['nm_pelajaran'] ?>" required>
