			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							<li class="active"><a href="data_kelas.php"><i class="fa fa-folder-open"></i> Data Kelas</a></li>
								...
								<table class="table table-hover" id="myTable">
									...
									<tr>
										...
										<td valign="center" style="float:right">
											<a href="edit_data_kelas.php?id=<?php echo $data['id'] ?>" title="Edit">
										...
										<td valign="center">
											<a href="hapus_kelas.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Anda yakin akan menghapus data?')" title="Hapus">
												<button type="button" class="btn btn-default btn-sm">
