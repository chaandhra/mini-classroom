...
<?php
if (isset($_GET['id'])) {
    $query = $DB_con->query("SELECT * FROM soal_ujian WHERE id = '$_GET[id]'");
    $data  = $query->fetch(PDO::FETCH_ASSOC);
} else {
    echo "ID tidak tersedia!
<a href='data_soal.php'>Kembali</a>";
    exit();
}
	...
	<div class="wrapper">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							...
							<li class="active"><a href="edit_data_soal.php"><i class="fa fa-edit"></i> Edit Data Soal</a></li>
						</ul>
					</li>
					<li class="treeview">
						<a href="#">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<form method="post" class="eusi" enctype="multipart/form-data" action="update_soal.php" style="margin-left:auto;margin-right:auto;background-color:#fff">
					<div class="container" style="width:100%">
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="hidden" name="id" value="<?php echo $data['id'] ?>">
						<?php
							include 'koneksi.php';
						...
						<textarea style="resize: none;width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" placeholder="Pertanyaan" name="pertanyaan" required><?php echo $data['pertanyaan'] ?></textarea>
						<div class="imgcontainer">
							<img src="<?php echo"upload/soal/".$data['gambar'] ?>" id="preview_gambar" alt="Tidak ada gambar" class="avatar" style="width: 50%;height:auto;border-radius:0;margin-top: 0;margin-bottom: 0;">
						...
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Jawaban A" name="a" value="<?php echo $data['a'] ?>" required>
						<label>Jawaban B</label>
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Jawaban B" name="b" value="<?php echo $data['b'] ?>" required>
						<label>Jawaban C</label>
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Jawaban C" name="c" value="<?php echo $data['c'] ?>" required>
						<label>Jawaban D</label>
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Jawaban D" name="d" value="<?php echo $data['d'] ?>" required>
						<label>Jawaban E</label>
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Jawaban E" name="e" value="<?php echo $data['e'] ?>" required>
						...
						<select style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" placeholder="Kunci Jawaban" name="kunci" required>
							<option><?php echo $data['kunci'] ?></option>
