...
<?php
	if (isset($_GET['kd_soal'])) {
		$query = $DB_con->query("SELECT * FROM soal_ujian WHERE kd_soal = '$_GET[kd_soal]'");
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Tambah Lagi Soal</li>
				</ol>
			</section>
			<section class="content">
				<form method="post" class="eusi" enctype="multipart/form-data" action="simpan_soal.php" style="margin-left:auto;margin-right:auto;background-color:#fff">
					<div class="container" style="width:100%">
						...
						<input style="width:100%; padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" placeholder="Kode Soal" name="kd_soal" value="<?php echo $data['kd_soal']; ?>" readonly="readonly" required>
						<?php
							include 'koneksi.php';
						...
						<div class="imgcontainer">
							<img src="" id="preview_gambar" alt="" class="avatar" style="width: 70%;border-radius:0;margin-top: 0;margin-bottom: 0;">
