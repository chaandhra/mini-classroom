	...
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active treeview">
						...
						<ul class="treeview-menu">
							<li class="active"><a href="data_tugas.php"><i class="fa fa-folder-open"></i> Data Tugas</a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<input class="alus" style="padding: 12px 20px; margin: 8px 0; display: inline-block;border: 1px solid #ccc; box-sizing: border-box;" type="text" id="myInput" onkeyup="ngajaran()" placeholder="Cari Judul Tugas">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="myTable">
					...
					<?php
						include 'koneksi.php';
					    $sql = "SELECT * FROM tugas,guru WHERE guru.nip = '$_SESSION[nisn_nip]' AND tugas.pelajaran = guru.nm_pelajaran ORDER BY id DESC";
					...
					?>
						<tr>
							...
							<td valign="center">
								<a href="hapus_tugas.php?id=<?php echo $data['id'] ?>" title="Hapus" onclick="return confirm('Anda yakin akan menghapus data?')">
